        ...
        <div className="bg-white rounded-2xl p-8 shadow-glass" style={{ border: '1px solid var(--border-purple)' }}>
          {sent ? (
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold mb-2" style={{ fontFamily: 'Outfit, sans-serif', color: 'var(--text-primary)' }}>Check your email</h2>
            ...
            <>
              <h2 className="text-xl font-bold mb-1" style={{ fontFamily: 'Outfit, sans-serif', color: 'var(--text-primary)' }}>Forgot password?</h2>
              ...
              <p className="text-center mt-5 text-sm">
                <Link to="/login" style={{ color: '#7C3AED', fontWeight: 600 }}>← Back to login</Link>
              </p>
            </>
          )}
        </div>
