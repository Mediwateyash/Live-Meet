...
export default function CourseFeaturePage({ feature }) {
  ...
  return (
    <PageLayout noFooter={true}>
      <div className="flex flex-col w-full px-6 lg:px-10" style={{ minHeight: 'calc(100vh - 64px)', background: 'var(--bg-page)' }}>
        ...
        {/* Main Flex Layout */}
        <div className="flex-1 w-full pt-2 pb-6">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            
            {/* Left Column: Learning Center Sidebar */}
            <div className="w-full lg:w-[260px] shrink-0">
              <div className="bg-white dark:bg-[var(--bg-surface)] rounded-[24px] shadow-sm border border-gray-150 dark:border-[var(--border-default)] overflow-hidden">
                {/* Header */}
                <div className="flex items-center gap-3 p-5 border-b border-gray-150 dark:border-[var(--border-default)]">
                  <div className="w-10 h-10 rounded-2xl flex items-center justify-center bg-[#7C3AED] text-white">
                    <Brain size={20} />
                  </div>
                  <span className="text-sm font-bold tracking-wider text-gray-500 dark:text-gray-400" style={{ fontFamily: 'Outfit, sans-serif' }}>
                    LEARNING CENTER
                  </span>
                </div>
                ...
                <div className="p-4 space-y-2">
                  {Object.entries(FEATURES).map(([key, { icon: NavIcon, label: navLabel }]) => {
                    ...
                    const colors = NAV_COLORS[key] || { iconBg: '#F3F4F6', iconColor: '#9CA3AF' };
                    
                    return (
                      <button
                        key={key}
                        onClick={() => key === 'certificate' ? navigate(`/certificate/${slug}`) : navigate(`/course/${slug}/${key}`)}
                        className={`w-full flex items-center gap-3.5 px-4 py-3 rounded-2xl transition-all font-semibold text-sm ${
                          active 
                            ? 'bg-[#EDE9FE] dark:bg-[rgba(124,58,237,0.12)] text-[#7C3AED] dark:text-[#A78BFA]' 
                            : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[rgba(255,255,255,0.02)]'
                        }`}
                      >
                        <div 
            ...
            <div className="flex-1 min-w-0 w-full">
              <div className={`w-full ${(!isLive && feature !== 'notes' && feature !== 'progress') ? 'flex flex-col items-center justify-center min-h-[50vh]' : ''}`}>
                {isLive ? (
                  <div className="max-w-3xl w-full text-left">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <h2 className="text-xl font-bold text-left" style={{ fontFamily: 'Outfit, sans-serif', color: 'var(--text-primary)' }}>Live Lectures</h2>
                  ...
                  <div className="w-full space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start text-left">
                      ...
                      {/* Right Panel: Inline PDF viewer (col-span-8) */}
                    ...
                    {/* AI Generated Study Materials & WH Questions */}
                    <div className="mt-12 pt-8 border-t border-gray-150 dark:border-gray-850">
                      <CourseNotes />
                    </div>
                  </div>
                  ...
                  loadingProgress ? (
                    ...
                    <div className="max-w-4xl w-full space-y-8 animate-fadeIn text-left">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="md:col-span-2 bg-white dark:bg-[var(--bg-surface)] p-6 rounded-2xl shadow-md border border-gray-150 dark:border-[var(--border-default)] flex flex-col justify-between">
                          <div>
                            <h3 className="text-xl font-bold mb-1 text-left" style={{ color: 'var(--text-primary)' }}>Course Completion</h3>
                            <p className="text-sm mb-4 text-left" style={{ color: 'var(--text-secondary)' }}>Track your lesson viewing progress</p>
                          </div>
                          ...
                          <div className="flex items-center gap-6">
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              <div className="flex justify-between text-xs font-semibold text-left" style={{ color: 'var(--text-secondary)' }}>
                        ...
                        <div className="bg-white dark:bg-[var(--bg-surface)] p-6 rounded-2xl shadow-md border border-gray-150 dark:border-[var(--border-default)] flex flex-col justify-between">
                          <div className="flex items-start justify-between">
                            <div>
                              <h3 className="text-lg font-bold mb-1 text-left" style={{ color: 'var(--text-primary)' }}>Certification</h3>
                              <p className="text-xs text-left" style={{ color: 'var(--text-secondary)' }}>Earn yours by finishing the course</p>
                            </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Milestones Card */}
                        <div className="bg-white dark:bg-[var(--bg-surface)] p-6 rounded-2xl shadow-md border border-gray-150 dark:border-[var(--border-default)] text-left">
                          <h3 className="text-lg font-bold mb-4 text-left" style={{ color: 'var(--text-primary)' }}>Milestones</h3>
                          <div className="space-y-4">
                            <div className="flex items-center justify-between p-3.5 rounded-xl bg-gray-50 dark:bg-gray-900/40 border border-gray-100 dark:border-gray-800">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-left" style={{ color: 'var(--text-muted)' }}>Watch all learning videos</p>
                                </div>
                              </div>
                            ...
                            <div className="flex items-center justify-between p-3.5 rounded-xl bg-gray-50 dark:bg-gray-900/40 border border-gray-100 dark:border-gray-800">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-left" style={{ color: 'var(--text-muted)' }}>Complete all course tests</p>
                                </div>
                              </div>
                        ...
                        <div className="bg-white dark:bg-[var(--bg-surface)] p-6 rounded-2xl shadow-md border border-gray-150 dark:border-[var(--border-default)] flex flex-col justify-between text-left">
                          <div>
                            <h3 className="text-lg font-bold mb-3 text-left" style={{ color: 'var(--text-primary)' }}>Resume Learning</h3>
                            <p className="text-sm mb-4 text-left" style={{ color: 'var(--text-secondary)' }}>Pick up right where you left off in this course.</p>
                          </div>
                          <button 
                      ...
                      <div className="bg-white dark:bg-[var(--bg-surface)] p-6 rounded-2xl shadow-md border border-gray-150 dark:border-[var(--border-default)] text-left">
                        <h3 className="text-lg font-bold mb-4 flex items-center gap-2 text-left" style={{ color: 'var(--text-primary)' }}>
                          <ClipboardList size={18} className="text-[#7C3AED]" /> Assessment Performance
                        </h3>
                        
                        {results.length === 0 ? (
                          <div className="text-center py-10 border border-dashed border-gray-200 dark:border-gray-850 rounded-xl bg-gray-50 dark:bg-gray-900/30">
                            <p className="text-sm text-center" style={{ color: 'var(--text-secondary)' }}>You haven't attempted any quizzes for this course yet.</p>
                ...
                <button
                  ...
                  className="mt-6 flex items-center gap-2 text-sm font-medium transition-colors hover:text-[#7C3AED] mr-auto"
