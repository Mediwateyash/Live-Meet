 ...
 */
export const generateMCQs = async ({ text = null, fileBuffer = null, mimeType = null, numQuestions = 10, startPage = null, endPage = null, chapterName = null }) => {
    ...
    - Generate MCQs ONLY from Page ${startPage} to Page ${endPage}.
    - Ignore any and all content, topics, or text outside this precise page range.
    - Do NOT generate questions from the title page, table of contents, or index unless they fall within this range.
    ...
    - Please ensure the generated questions are highly relevant to this specific topic/chapter.`;
    }
    ...
    for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
        try {
            ...
            console.log(`[aiService] Temporary failure. Waiting ${delay}ms before retry...`);
            await sleep(delay);
        }
    }
};
