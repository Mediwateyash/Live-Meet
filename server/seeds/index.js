...
const COURSES_DATA = [
  ...
  { title: 'Introduction to Cybersecurity', category: 'Cybersecurity', level: 'Beginner', price: 499, description: 'Master the core concepts of cybersecurity, network security, and cryptography to defend systems from cyber threats.', whatYouLearn: ['Core security principles (CIA Triad)', 'Types of cyber attacks and defenses', 'Basic Cryptography (Symmetric & Asymmetric)', 'Network security fundamentals'], requirements: ['Basic computer literacy'], curriculum: [{ title: 'Introduction to Cyber Security', lessons: [{ title: 'Course Overview', duration: 300, isFree: true }, { title: 'What is Cybersecurity?', duration: 600, isFree: true }, { title: 'The CIA Triad Explained', duration: 750, isFree: false }] }] },
]
...
async function seed() {
  try {
    ...
    // Create courses
    const instructors = [inst1, inst2, inst1, inst2, inst1, inst2, inst1]
